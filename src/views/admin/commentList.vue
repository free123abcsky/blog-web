    ...
    <div class="comments">
      ...
      <section class="commentList">
        ...
        <section class="commentList--dropdown">
          ...
          <k-button type="info" @click="Condition_main=0,Condition_reply=0,Condition_auth=0,btn_filter_mainComm=btn_filter_reply=btn_filter_auth='全部'">
        ...
        <div class="comments__ask animated fadeIn"
          ...
          <div class="comments__ask__title">
            ...
            <div class="comments__ask__title--btns">
              <k-button :type="{true:'success',false:'warning'}[!item.state]" size="sm" @click="changeAuthState(item._id),item.state=!item.state;"
                      >
                <icon :type="{true:'android-radio-button-on',false:'android-radio-button-off'}[!item.state]"></icon>
              </k-button>
              <k-button type="default" v-if="!item.isIReplied" size="sm" @click="comment(item)" data-toggle="modal"
                      data-target="#addComm">
                <icon type="edit"></icon>
              </k-button>
              <k-button type="danger" size="sm" @click="delbtn(item)" data-toggle="modal"
                      data-target="#delComm">
